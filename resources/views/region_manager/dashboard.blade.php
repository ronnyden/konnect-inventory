            ...
            <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                  <button type="button" class="inline-block px-6 py-2.5  text-dark font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-bs-toggle="modal" data-target="#profilemodal">
                      Profile
                  </button>
                    <a
                      href="#"
                    ...
                    >
                    @csrf
                    <i class="fa fa-power-off"></i><button type="submit">Logout</button>
                    </form>
                  </div>
                </div>
                <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="profilemodal" tabindex="-1" aria-labelledby="exampleModalXlLabel" aria-modal="true" role="dialog">
            ...
            <div class="mt-2">
              ...
              <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  ...
                  <div>
                    <span>
                      <i class="fa fa-cart-plus fa-2x text-orange-400"></i>
                    </span>
                  </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  ...
                  <div>
                    <span>
                      <i class="fa fa-shopping-bag fa-2x text-green-400"></i>
                    </span>
                  </div>
                </div>
